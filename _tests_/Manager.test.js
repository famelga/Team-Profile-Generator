...
describe("Manager class", () => {
  ...
  describe("Can identify name error", () => {
      ...
      it("should throw an error if 'name' is not a string", () => {
          const cb = () => new Manager(2023, 30, "fam@me.me");
...
describe("Can identify id error", () => {
    it("should throw an error if 'id' is not a number", () => {
        const cb = () => new Manager("Fayven", "30", "fam@me.me");
...
describe("Can identify email error", () => {
    it("should throw an error if 'email' is not a string", () => {
        const cb = () => new Manager("Fayven", 30, 2023);
        const err = new Error(
...
describe("Can identify school error", () => {
  ...
  describe("Can get email via getEmail", () => {
    ...
    it("returns Manager's email", () => {
      const testManager = new Manager("Fayven", 30, "fam@me.com", "umd");
